...
import { Box, Paper, Typography, TextField, Button, Alert, CircularProgress, IconButton, InputAdornment } from '@mui/material';
...
const PrimeiroAcessoPage: React.FC = () => {
  const { mode, toggleTheme } = useCustomTheme();
  const navigate = useNavigate();
  const [formData, setFormData] = useState({ email: '', novaSenha: '', confirmarSenha: '' });
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setLoading(true);
    try {
      await authService.primeiroAcesso(formData.email, formData.novaSenha);
      setSuccess('Senha definida com sucesso! Você já pode acessar o sistema.');
    ...
    <>
      ...
      >
        ...
        >
          ...
          >
            Defina sua primeira senha para acessar o sistema
          </Typography>

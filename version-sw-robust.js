 ...
 * Uso: node scripts/version-sw-robust.js <patch|minor|major> [mensagem]
 */
...
function main() {
  ...
  if (!versionType || !['patch', 'minor', 'major'].includes(versionType)) {
    console.error('❌ Uso: node scripts/version-sw-robust.js <patch|minor|major> [mensagem]');
    console.error('📝 Exemplo: node scripts/version-sw-robust.js patch "Fix notification timing"');
    process.exit(1);
  }
